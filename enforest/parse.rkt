...
(define-syntax-class macro-expr
  [pattern e #:when (honu-macro? #'e)])
(define-syntax-class fixture-expr
  [pattern e #:when (honu-fixture? #'e)])
(define-syntax-class op-expr
  [pattern e #:when (honu-operator? #'e)])
